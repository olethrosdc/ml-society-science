...
\begin{frame}
  \begin{exercise}
    ...
    \only<4>{\input{../figures/p-value-example-rejection.tikz}}
  \end{exercise}
\end{frame}

\begin{frame}
  \frametitle{The Bayesian test}

  \only<1>{\input{../figures/p-value-example-posterior.tikz}}
  \only<2>{\input{../figures/p-value-example-null-posterior.tikz}}
  \only<>{\input{../figures/p-value-example-true-posterior.tikz}}
\end{frame}
\begin{frame}
