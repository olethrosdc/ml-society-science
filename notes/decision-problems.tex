...
\uncover<2->{
  \begin{enumerate}
  \item<2-> What is your belief about the quality of each meteorologist after each day? (i.e. your posterior)
  \item<3-> What is your belief about the probability of rain each day? (i.e. the marginal probability of rain)
    \[
