  ...
  \begin{frame}
    ...
    \begin{figure}
      ...
      \begin{columns}
        ...
        \end{column}
      \end{columns}
      \caption{Linkage attack on a anonymised patient information database.}
    \end{figure}
    \only<article>{
...
\only<article>{ The above discussion should help emphasise that what a
  given dataset contains cannot be characterised as private or
  non-private. We should actually start from the observation that any
  data contributed by an individual can be considered private, because
  it could be combined with other datasets to obtain sensitive
  personal information.

  For that reason, we wish to ensure that 
...
\only<article>{
  ...
  \begin{exercise}
    ...
    \[
      \pol(A | \bx) \leq e^\epsilno \pol(A | \bx'),
