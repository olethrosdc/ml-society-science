...
\begin{frame}
  ...
  \begin{example}[Typical relational database in a tax office]
    \begin{tabular}{l|l|l}
      ID & Name & Deposits & Age & Postcode & Profession\\
      \hline
  ...
  \begin{example}[Typical relational database in Tinder]
    \begin{tabular}{l|l|l}
      Birthday & Name & Height  & Weight & Salary & Deposits & Age Range & Postcode & Profession\\
      \hline
      0607 & Mike Pence & 190cm & 80kg & 150,000 & 1e6 & 60+ & 1001 & Politician\\
      0614 & Donald Trump & 185cm & 110kg & 300,000 & -1e9 & 60+ & 1001 & Rentier\\
      0101 & A. B. Student & 170cm & 70kg & 10,000 & 100,000 & 40-60 & 1001 & Time Traveller
    \end{tabular}
  \end{example}
\end{frame}
