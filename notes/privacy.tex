...
While the exponential mechanism is quite abstract, it is very flexible. Many problems in machine learning and database queries can be answered, in principle, using it. 
\begin{exampleblock}{Answering database queries with the exponential mechanism.}
  
\end{exampleblock}
\begin{exampleblock}{The exponential mechanism for learning}
