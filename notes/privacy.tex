...
\begin{frame}
  ...
  \only<article>{ This form is related to standard notions of
    ...
    x)$. It essentially says, that if $x, x'$ are similar then it will be hard to tell from the algorithm's output whether it was generated by $x$ or $x'$, because the output distribution will be almost the same. So, it will be difficult for an adversary to guess the data by seeing the output.
