...
\begin{frame}
  ...
  \only<article>{
    The notion of differential privacy was introduced by~\citet{dwork2006calibrating}, where the authors specifically related the ability of an adversary to distinguish dataset $x, x'$ to how similar the distributions of outputs would be in each case. 
    ...
    x)$ and the total variation $\max_A |\pol(A \mid x) - \pol(A \mid x')|$.  However, the above inequality is more commonly written as
    \[
