...
The privacy attack in the Massachusetts database is detailed in~\citep{sweeney2002k}, while $k$-anonymity is described more thoroughly in  in~\citep{samarati1998protecting}. Differential privacy, not actually given that name at the time, was introduced in~\citep{dwork2006calibrating}.
The exponential mechanism was introduced by \citet{mcsherry2007mechanism}, with an application to approximately truthful mechanism design. This direction was further investigated by~\citet{kearns:md-privacy,nissim:ao-md:2012}.
A technical book on differential privacy by \citet{dwork2014algorithmic} covers all of the fundamentals.
Randomness, privacy, and the US 2020 census \cite{garfinkel2020randomness}.
Bayesian inference and privacy \cite{bayesiandp}
Local differential privacy and statistics \cite{duchi2013local}
