...
\begin{frame}
  ...
  \only<article>{However, anonymisation is not enough as record linkage can allow you to still extract information using data from another database}
...
\begin{tikzpicture}
    \draw (0,0) circle (1.5cm) node[below] {\parbox{0.3\textwidth}{Race\\Date\\X}};
