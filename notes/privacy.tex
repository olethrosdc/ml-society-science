...
\only<article>{
  ...
  \only<article>{These theorem are very useful tools, as they allows us to create new mechanisms that are composed of simpler parts. As a first example, we can look at how we can use sequential copmosition, to create a randomised response algorithm when the respondents provide multiple attributes.}
