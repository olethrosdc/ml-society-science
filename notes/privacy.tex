...
\begin{frame}
  ...
  \begin{example}
    ...
    \begin{figure}
    \begin{tikzpicture}[scale=4, domain=0:1]
      \draw[color=blue]   plot (\x, {\x*0.1 / (\x*0.1 + (1 - \x)*0.9)});
      \draw[color=magenta]   plot (\x, {\x*0.5 / (\x*0.5 + (1 - \x)*0.5)});
      \draw[color=red]   plot (\x, {\x*0.9 / (\x*0.9 + (1 - \x)*0.1)});
    \end{tikzpicture}
    \end{figure}
