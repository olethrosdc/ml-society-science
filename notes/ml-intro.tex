...
\begin{frame}
  ...
  \only<article>{Sometimes we want to use a simple simulation study to understand how well our methods work. The following code is an example of how to do this. Here we are doing a simplified fMRI analysis, but the general idea is not significantly different from what people actually do in the field.}
...
\begin{frame}
  ...
  \begin{block}{Resources}
    \begin{itemize}
    \item Online QA platform:
    \item Course code and notes: 
    \item Book 
    \end{itemize}
  \end{block}
\end{frame}
