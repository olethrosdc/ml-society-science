  ...
  \begin{frame}
    ...
    \begin{columns}
      ...
      \begin{column}{0.3\textwidth}
        \centering
\uncover<1->{\includegraphics[width=\fwidth]{../figures/rl_worlds}
          \\
          prior
        }
        \\
        \uncover<2->{\includegraphics[width=\fwidth]{../figures/rl_observations}
          \\
          evidence
        }
        \\
        \uncover<4->{\includegraphics[width=\fwidth]{../figures/rl_worlds2}
          \\ 
          conclusion
        }
      \end{column}
