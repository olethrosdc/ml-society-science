...
from Bayes's theorem, we see that we can obtain the probability of the class:
  ...
  \uncover<2->{
    \begin{example}[Normal distribution]
      \only<2,4>{\includegraphics[width=\textwidth]{../figures/equal-variance}}
      \only<3>{\includegraphics[width=\textwidth]{../figures/unequal-variance}}
      \only<5>{\includegraphics[width=\textwidth]{../figures/unequal-prior}}
    \end{example}
  }
  \uncover<3>{
