...
\begin{lemma}[Hoeffding's inequality]
  ...
  \end{equation}
\end{lemma}
When $x_t$ are i.i.d, $\E \mu_n = \E x_t$. This allows us to construct an interval of size $\epsilob$ around the true mean. This can generalise to a two-sided interval:
\[
