...
\frametitle{Inference and prediction in graphical models}
 \begin{figure}[H]
     ...
     \end{tikzpicture}
     \caption{Inference and prediction in a graphical model. \only<article>{In this particular example, $x_1, \ldots, x_t$ are all i.i.d, drawn from the distribution $P_\param$.}}
  \end{figure}
  \only<1>{
