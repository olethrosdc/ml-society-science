...
\only<article>{ Fairness encompasses many different ideas. For each
  ...
  Legislation and judicial decisions also define fairness in terms of the \emph{process} itself. Individual outcomes themselves do not usually play a role. However, intent is usually important in \emph{direct} discrimination (where different groups are explicitly treated differently) but not in \emph{indirect} discrimination: For example, in the US, a company had instituted some cognitive tests for promotion.  These were negatively affecting black   employees disproportionately. Because of this, and since they were unrelated to work requirements, they were found to be discriminatory by the US supreme court in~\citet{griggs1971}. This was later codified in US law. An EU example is \citet{bilka1986}. This involved a female part-time worker who was denied pension payments, because the company only issued them to full-time workers. However, most part-time workers were female. The European court of justice ruled that if there is no economic need for a policy which disadvantages a group, then it is indirectly discriminatory.
  In \citet{eu2000racial}, direct and indirect discrimination on the basis of race is prohibited. In article 19 of the EU Treaty, the list extends to religion/belief, age, racial/ethnic origin, disability and sexual orientation,  while In Article 21 of the Charter of Fundamental Rights, discrimination is defined with respect to potentially \emph{any} variable, including political views, social origin, language and property. That said, \emph{affirmative action} which does treat distinct groups differently, is considered permissible as long as it corrects an existing discriminatory situation. For example, normal-intelligence Roma children that were placed in special education schools in Czechia due to aptitude tests were found to be discriminated against. The court prescribed an affirmative action policy to reverse this, even though it meant they had to explicitly treat Roma cihldren differently.
...
+  
+  An EU parallel is~\citet{bilka1986}, which involved a female part-time worker who was denied pension payments because the company only issued them to full-time workers. Because the vast majority of part-time workers were female, the European Court of Justice ruled that if there is no objective economic need for a policy which disadvantages a group, it is indirectly discriminatory, regardless of the employer's intent.
+
+  In~\citet{eu2000racial}, direct and indirect discrimination specifically on the basis of racial or ethnic origin is prohibited in secondary EU legislation. In primary EU law, Article 19 of the Treaty on the Functioning of the European Union (TFEU) provides a closed, restrictive list of protected grounds upon which the EU may legislate (sex, racial or ethnic origin, religion or belief, disability, age, and sexual orientation). In contrast, Article 21 of the Charter of Fundamental Rights provides an open-ended, non-exhaustive prohibition of discrimination based on ``any ground such as'' sex, race, color, ethnic or social origin, genetic features, language, religion or belief, political or any other opinion, membership of a national minority, property, birth, disability, age, or sexual orientation. 
+
+  That said, \emph{affirmative action}, which does treat distinct groups differently, is considered permissible as long as it corrects an existing discriminatory situation. For example, normal-intelligence Roma children that were placed in special education schools in Czechia due to culturally biased aptitude tests were found to be discriminated against. The court prescribed an affirmative action policy to reverse this, even though it meant they had to explicitly treat Roma children differently.
  ...
  \begin{exercise}
    ...
    \iftrue
      ...
      \begin{align*}
        ...
        &\approx \frac{1}{T} \sum_{t=1}^T [\pol(a_t | x_t, z_t)  - 1]\ind{z_t=z},
      \end{align*}
      where $T_z$ is the number of examples with $z_t = z$.
    \fi
  \end{exercise}
  \only<presentation>{
...
\only<article>{Let us first discuss the concept of meritocracy as it
  ...
  typically submits an ordered list of preferences and they are
  ...
  specific, invariant, inherent worth. They also have a clear
...
\only<article>{ Another principle for individual fairness is
  ...
  Let us first consider policies that make separate decisions for
  ...
  \begin{block}{Treating similar individuals similarly.}
    ...
    \end{equation}
  \end{block}
  This formulation suggests that similar individuals (in terms of $d$) are treated similarly (in terms of $D$). Hence, their choice dictates the semantic of ``similarly''. It is also possible that we have not settled on an appropriate metric $d$ with respect to the features. 
  Finally, the policy may not have the independence property, so the above Lipschitz condition may not be properly defined. There are also differences in the available solutions for the optimisation problem when we are dealing with a fixed population versus a distribution over populations.
