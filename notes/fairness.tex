...
\only<article>{ Needless to say, there are many problems related to
  group fairness with respect to gender and ethnicity in particular.
  However,
}
...
\begin{frame}
  ...
  \only<article>{ For our example regarding disadvantaged populations,
    consider the example of bail decisions in the US court
