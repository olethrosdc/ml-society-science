...
\begin{frame}
  ...
  \only<article>{In this setting, a defendant $t$ appears before a
    ...
    \end{align*}
    Of course, in the original data we have only some specific $a_t, y_t$ for every individual $t$, where $a_t$ was selected by some historical policy $\pol$.
