...
\only<article>{ The very concept of fairness is not well-defined
  ...
  society. On the other hand, \emph{non-discrimination} captures the notion of
  not treating people differently depending on sensitive
  characteristics. This encompasses both the concept of \emph{equality of opportunity} and \emph{equality of outcome}.}
