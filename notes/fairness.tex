...
\only<article>{ Fairness encompasses many different ideas. For each
  ...
  Legislation and judicial decisions also define fairness in terms of the process itself. The intent or individual outcomes themselves do not usually play a  role. For example, in the US, a company had instituted some cognitive tests for promotion. However, since these were unrelated
  to the work requirements and were negatively affecting black
  employees disproportionately, they were found to be discriminatory
  by the US supreme court in~\citet{griggs1971}. This was later codified in law. European law was partly formed by the case \citet{bilka1986}, where a female part-time worker was denied pension payments, because the company only issued them to full-time workers. However, most part-time workers were female. The European court of justice ruled that if there is no economic need for a policy which disadvantages a group, then it is indirectly discriminatory.
  In \citet{eu2000racial}, direct and indirect discrimination on the basis of race is prohibited. In article 19 of the EU Treaty, the list also includes religion/belief, age, racial/ethnic origin, disability and sexual orientation,  while In Article 21 of the Charter of Fundamental Rights, discrimination is defined with respect to potentially \emph{any} variable, including political views, social origin, language and property.
