...
\only<article>{ Another principle for individual fairness is
  ...
  $X \subset \CX$. This allows us to define the utility in terms of
...
\only<article>{
  ...
  \end{exercise}
  \begin{proof}
    The solution is relatively simple. Consider that 
  \end{proof}
