...
\only<article>{
  ...
  Importance sampling may be hard to apply for fairness, because it represents a more complex interaction between the policy $\pol$ an the process $P_\theta$ than the expected utility, which a simple sum. 
