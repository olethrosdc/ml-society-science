...
|       |                                        |       |                                       |
|-------+----------------------------------------+-------+---------------------------------------|
| 19.10 | Lab: TFP                    (Dirk)     | 20.10 | Balance                               |
|       |                                        |       | Calibration                           |
|       |                                        |       | Meritocracy                           |
|       |                                        |       |                                       |
|-------+----------------------------------------+-------+---------------------------------------|
...
|-------+----------------------------------------+-------+---------------------------------------|
| 26.10 | Lab: Constrained Classification (Dirk) | 27.10 | Latent Variable Models                |
|       |                                        |       | Recommender Systems                   |
|-------+----------------------------------------+-------+---------------------------------------|
|  2.11 | Lab: Latent Variable Models (Dirk)     |  3.11 | Causality                             |
|       |                                        |       | Interventions                         |
|       |                                        |       | Counterfactuals                       |
|-------+----------------------------------------+-------+---------------------------------------|
|  4.10 | Project 2                              |       | Deadline #1                           |
|-------+----------------------------------------+-------+---------------------------------------|
|  9.11 | Causality                              | 10.11 | tfcausalimpact                        |
|       |                                        |       |                                       |
|       |                                        |       |                                       |
|-------+----------------------------------------+-------+---------------------------------------|
| 16.11 | Markov decision processes              | 17.11 | Thompson sampling                     |
|-------+----------------------------------------+-------+---------------------------------------|
| 18.10 | Project 2                              |       | Deadline #2                           |
|-------+----------------------------------------+-------+---------------------------------------|
| 23.11 | Lab: Project work                      | 24.11 | Lab: Q&A                              |
|-------+----------------------------------------+-------+---------------------------------------|
