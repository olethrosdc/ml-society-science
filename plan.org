...
*** Papers
1. Resolving Individuals Contributing Trace Amounts of DNA to Highly Complex Mixtures Using High-Density SNP Genotyping Microarrays.
2. Needles in the Haystack: Identifying Individuals Present in Pooled Genomic Data.
3. Genomic privacy and limits of individual detection in a pool
4. Privacy Preserving GWAS Data Sharing
