...
| 26 Aug | L2. Classification, Decision Problems, Project Overview        | Christos |
| 27 Aug | A2. Bootstrapping, XV, project #1 introduction                 | Dirk     |
|--------+----------------------------------------------------------------+----------|
| 2 Sep  | L3. Decision Problems, Classification, Neural Networks, SGD    | Christos |
| 3 Sep  | A3. Compare kNN/MLP, discover interesting features             | Dirk     |
| 9 Sep  | L4. Bayesian inference tutorial; neural networks               | Christos |
