...
|-------+----------------------------+-------+------------------------------------------|
|  21.9 | Databases, anonymity, GDPR |  22.9 | SQL, DB tutorial                         |
|       | Differential privacy       |       | Private data collection                  |
|       | Randomised response        |       |                                          |
|-------+----------------------------+-------+------------------------------------------|
|  30.9 | Project 1                  |       | PRELIMINARY REPORT                       |
|-------+----------------------------+-------+------------------------------------------|
| 28.10 | Laplace mechanism          | 29.10 | Lab: Compare mechanisms in an ML task    |
|       | Exponential mechnism       |       |                                          |
|-------+----------------------------+-------+------------------------------------------|
|  5.10 | Fairness                   |  6.10 | Graphical models with TFP         (Dirk) |
|       | Conditional independence   |       |                                          |
|-------+----------------------------+-------+------------------------------------------|
| 12.10 | Balance                    | 13.10 | Constrained classifiers           (Dirk) |
|       | Calibration                |       | Penalised classification          (Dirk) |
|       | Meritocracy                |       |                                          |
|       | Smoothness                 |       |                                          |
|-------+----------------------------+-------+------------------------------------------|
| 19.10 | Non-conjugate priors       | 20.10 | Tensor flow probability                  |
