...
|---+-------------------------------------------------------------+----------|
|   | Reproducibility, kNN                                        | Christos |
|   | Classification, Decision Problems                           | Christos |
|   | Python tutorial                                             | Dirk     |
|   | Project #1 introduction                                     | Dirk     |
|---+-------------------------------------------------------------+----------|
|   | Decision Problems, Hypothesis Testing, Neural Networks, SGD | Christos |
|   | Bayesian inference tutorial; neural networks                | Christos |
|   | ??                                                          | Dirk     |
|   | ??                                                          | Dirk     |
|   | Databases, anonymity, privacy                               | Christos |
|   | Differential privacy                                        | Christos |
|   | Differential privacy tutorial                               | Dirk     |
|   | Privacy lab                                                 | Dirk     |
|   | Fairness and graphical models                               | Christos |
|   | Estimating conditional independence                         | Christos |
|---+-------------------------------------------------------------+----------|
|   | Graphical model tutorial                                    | Dirk     |
|   | Project #2 Introduction                                     | Dirk     |
|   | Recommendation systems                                      | Christos |
|   | Latent variables and importance sampling                    | Christos |
|   | ?                                                           | Dirk     |
|   | ?                                                           | Dirk     |
|   | Causality                                                   | Christos |
|   | Interventions and Counterfactuals                           | Christos |
|   | Causality lab                                               | Dirk     |
|   | Causality lab                                               | Dirk     |
|   | Bandit problems                                             | Christos |
|   | Experiment design                                           | Christos |
|   | Experiment design lab                                       | Dirk     |
|   | Experiment design lab                                       | Dirk     |
|---+-------------------------------------------------------------+----------|
