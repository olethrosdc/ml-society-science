...
<<<<<<< HEAD
   ...
   |-------+-----------------------+-----------+-----------------------------------|
   |  27.9 | Algorithms            |           | The randomised response mechanism |
   |       | Privacy               |           |                                   |
   |       | Fairness              |           |                                   |
   |       | Reproducibility       |           |                                   |
   |-------+-----------------------+-----------+-----------------------------------|
   ...
   |       | k-anonymity           | Project1  |                                   |
   |-------+-----------------------+-----------+-----------------------------------|
   | 11.10 | Differential Privacy  |           | Staircase mechanism               |
   |       | Randomised response   |           |                                   |
   |       | Laplace Mechanism     |           |                                   |
   |-------+-----------------------+-----------+-----------------------------------|
...
=======
   ...
   | 16.12 |                        |                            |
   |-------+------------------------+----------------------------|
>>>>>>> b2158ea904f7c60e0ec79f6db80bc8aa8877622a

*** Papers
1. [[https://www.cs.utexas.edu/~shmat/shmat_oak08netflix.pdf][Robust De-anonymization of Large Sparse Datasets.]] Narayanan and Shmatikov.
2. Approximate DP: See also https://github.com/frankmcsherry/blog/blob/master/posts/2017-02-08.md
3. [[https://pramodv.ece.illinois.edu/pubs/GKOV.pdf][The staircase mechanism in differential privacy]].  Geng et al. 2015.
4. [[https://arxiv.org/abs/1702.07476][Renyi Differential Privacy]], Mironov, 2017.
5. [[https://eprint.iacr.org/2019/245.pdf][Distributed Differential Privacy via Shuffling]]. Cheu et al, 2019.
6. [[https://publications.ics.forth.gr/_publications/SECRYPT_2022_59_CR.pdf][Federated Naive Bayes under Differential Privacy.]] Marchioro et al.
7. [[https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2477899][Big Data's Disparate Impact]]. Barocas and Selbst, 2016.
8. Fair prediction with disparate impact: A study of bias in recidivism prediction instruments.
9. Inherent Trade-Offs in the Fair Determination of Risk Scores.
10. Meritocratic Fairness for Cross-Population Selection.
11. Fairness through awareness.
12. Resolving Individuals Contributing Trace Amounts of DNA to Highly Complex Mixtures Using High-Density SNP Genotyping Microarrays.
13. Needles in the Haystack: Identifying Individuals Present in Pooled Genomic Data.
14. Genomic privacy and limits of individual detection in a pool
15. Privacy Preserving GWAS Data Sharing
16. [[https://arxiv.org/pdf/1909.03577.pdf][A New Analysis of Differential Privacy’s Generalization Guarantees]] 
