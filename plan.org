...
|       |                                        |       | Counterfactuals                       |
|-------+----------------------------------------+-------+---------------------------------------|
|  9.11 | Lab: Importance Sampling  (Dirk)       | 10.11 | Adaptive Experiment Design            |
|       | tfcausalimpact                         |       |                                       |
|       |                                        |       |                                       |
|-------+----------------------------------------+-------+---------------------------------------|
|  8.10 | Project 2                              |       | PRELIMINARY REPORT                    |
|-------+----------------------------------------+-------+---------------------------------------|
| 16.11 | Lab; Thompson sampling (Dirk)          | 17.11 | Markov decision processes             |
|-------+----------------------------------------+-------+---------------------------------------|
| 23.11 | Lab: Project work                      | 24.11 | Lab: Q&A                              |
|-------+----------------------------------------+-------+---------------------------------------|
|  3.12 | Project 2                              |       | DEADLINE                              |
|-------+----------------------------------------+-------+---------------------------------------|
