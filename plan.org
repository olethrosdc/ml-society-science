...
| 28 Aug | A1. Python, scikitlearn, classification, holdouts, overfitting  | Dirk     |
| 29 Aug | A2. Bootstrapping, XV, project #1 introduction                  | Dirk     |
| 30 Aug | Mini-assigment                                                  |          |
|--------+-----------------------------------------------------------------+----------|
| 4 Sep  | L3. Decision Problems, Hypothesis Testing, Neural Networks, SGD | Christos |
| 5 Sep  | L4. Bayesian inference tutorial; neural networks                | Christos |
| 11 Sep | A3. Compare kNN/MLP, discover interesting features              | Dirk     |
| 12 Sep | A4. Project Lab                                                 | Dirk     |
| 17 Sep | L5. Databases, anonymity, privacy                               | Christos |
| 18 Sep | L6. Differential privacy                                        | Christos |
| 25 Sep | A5. DB tutorial/distributed computing                           | Dirk     |
...
|--------+-----------------------------------------------------------------+----------|
| 09 Oct | A7. Production ML: SageMaker/Pipelines                          | Dirk     |
