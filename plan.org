...
- Linear algebra in Euclidean spaces (MAT1110)
- Elementary calculus (MAT1100)
- Python programming (IN1900 – Introduction to Programming with Scientific Applications).
