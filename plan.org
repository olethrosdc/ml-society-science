...
| 29 Aug | A1. Python, scikitlearn, pandas, classification,                               | Dirk     |
|        | A2. Holdouts, overfitting, bootstrapping, XV, project #1 introduction          | Dirk     |
|--------+--------------------------------------------------------------------------------+----------|
...
| 12 Sep | A3. Advanced sklearn, pielines, Compare kNN/MLP, discover interesting features | Dirk     |
|        | A4. Advanced pandas, Project Lab                                               | Dirk     |
| 19 Sep | L5. Databases, anonymity, privacy                                              | Christos |
|        | L6. Differential privacy                                                       | Christos |
| 26 Sep | A5. Distributed computing and Spark, (No-)SQL, JSON                            | Dirk     |
...
|--------+--------------------------------------------------------------------------------+----------|
| 10 Oct | A7. Production ML, how to use ML in larger projecs, Sagemaker, Pipelines       | Dirk     |
...
| 24 Oct | A9. Advanced Spark, ALS, Pipelines                                             | Dirk     |
|        | A10. Severless Machine Learning, APIs, REST                                    | Dirk     |
| 31 Oct | L11. Causality                                                                 | Christos |
|        | L12. Interventions and Counterfactuals                                         | Christos |
| 7 Nov  | A11. Basic NLP                                                                 | Dirk     |
|        | A12. More on NLP                                                               | Dirk     |
| 14 Nov | L13. Bandit problems                                                           | Christos |
|        | L14. Experiment design                                                         | Christos |
| 21 Nov | A13. Levtovers: Trees, ensembles and boosting                                  | Dirk     |
