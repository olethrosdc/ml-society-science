...
| Theory                                             | Practice                                      |
|----------------------------------------------------+-----------------------------------------------|
| Decision problems                                  | Python intro, numpy, expectation              |
| Probability and Utility                            | Scikitlearn                                   |
| Decision problems in ML                            | Model selection, hyperparameters              |
|----------------------------------------------------+-----------------------------------------------|
| Basic experiment design                            | Data collection, pipelines  (Dirk)            |
| Decision analysis                                  | Bootstrapping, XV (Dirk)                      |
|----------------------------------------------------+-----------------------------------------------|
| Bayesian inference                                 | Meteorologists problem, Credible intervals    |
| Conjugate priors,                                  | Beta/Bernoulli, Linear regression             |
|----------------------------------------------------+-----------------------------------------------|
| Bayes-optimal decisions: discrete case             | Meteorologists continued                      |
| General case and connection with estimation        | Tensor flow Keras Optimisers (Dirk)           |
|----------------------------------------------------+-----------------------------------------------|
| Non-conjugate priors                               | Tensor flow probability (Dirk)                |
| Logistic regression                                | LR with TFP             (Dirk)                |
|----------------------------------------------------+-----------------------------------------------|
| Databases, anonymity, GDPR                         | SQL, DB tutorial        (Dirk)                |
| Differential privacy                               | Private data collection (Dirk)                |
| Randomised response                                | Distributed DB, OpenDP (opendp.org)           |
| Laplace mechanism                                  | Lab: Compare mechanisms in an ML task  (Dirk) |
| Exponential mechnism                               |                                               |
|----------------------------------------------------+-----------------------------------------------|
| Fairness introduction and conditional independence | Graphical models with TFP         (Dirk)      |
| Balanced/Calibrated classification                 | Constrained classifiers           (Dirk)      |
| Meritocracy and smoothness                         | Penalised classification          (Dirk)      |
|----------------------------------------------------+-----------------------------------------------|
| Latent variable models                             | Tensorflow Monte-Carlo methods    (Dirk)      |
| Examples: Outliers, recommendation systems         | Recommender systems                (Dirk)     |
|----------------------------------------------------+-----------------------------------------------|
| Causality                                          | Importance Sampling                           |
| Interventions and counterfactuals                  | tfcausalimpact                     (Dirk)     |
|----------------------------------------------------+-----------------------------------------------|
| Adaptive experiment design                         | Thompson sampling                             |
| Active learning, bandits                           | Active learning example with classification   |
| Markov decision processes                          | Approximations to the Bayes-optimal solution  |
|----------------------------------------------------+-----------------------------------------------|
