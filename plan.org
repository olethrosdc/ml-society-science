...
| Experiment design                 | Experimental analysis of a classifier   |
| Data prepration                   |                                         |
|-----------------------------------+-----------------------------------------|
| Bayesian inference                | Credible intervals, bootstrapping, XV   |
| Conjugate priors                  | Linear regression: ML/MAP vs Bayes      |
| Bayes-optimal decisions           | Tensorflow Probability intro            |
|-----------------------------------+-----------------------------------------|
...
|-----------------------------------+-----------------------------------------|
| Fairness introduction             | Tensorflow?                             |
| Conditional Independence          | Constrained classifiers                 |
| Meritocracy and smoothness        | Penalised classification                |
|-----------------------------------+-----------------------------------------|
| Latent variable models            | Tensorflow Monte-Carlo methods          |
| Causality                         | SCMs                                    |
