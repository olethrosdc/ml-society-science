...
*** Papers
1. [[https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2477899][Big Data's Disparate Impact]]. Barocas and Selbst, 2016.
2. [[https://www.cs.utexas.edu/~shmat/shmat_oak08netflix.pdf][Robust De-anonymization of Large Sparse Datasets.]] Narayanan and Shmatikov.
3. Approximate DP: See also https://github.com/frankmcsherry/blog/blob/master/posts/2017-02-08.md
4. [[https://pramodv.ece.illinois.edu/pubs/GKOV.pdf][The staircase mechanism in differential privacy]].  Geng et al. 2015.
5. [[https://arxiv.org/abs/1702.07476][Renyi Differential Privacy]], Mironov, 2017.
6. [[https://eprint.iacr.org/2019/245.pdf][Distributed Differential Privacy via Shuffling]]. Cheu et al, 2019.
7. [[https://publications.ics.forth.gr/_publications/SECRYPT_2022_59_CR.pdf][Federated Naive Bayes under Differential Privacy.]] Marchioro et al.
