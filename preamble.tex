...
{\begin{mdframed}[roundcorner=10pt,backgroundcolor=black!10,frametitle={#1}]}
{\end{mdframed}}

\renewenvironment{exampleblock}[1]
{\begin{mdframed}[roundcorner=20pt,backgroundcolor=blue!10,frametitle={#1}]}
{\end{mdframed}}


\renewenvironment{alertblock}[1]
{\begin{mdframed}[roundcorner=10pt,backgroundcolor=green!10,frametitle={#1}] \hrule}
{\end{mdframed}}
}
