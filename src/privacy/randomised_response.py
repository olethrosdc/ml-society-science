...
def rp_binary(data: np.array, epsilon: np.float):
    ...
    ## TODO: set p correctly depending on features. Let p be the
    ## probability with which you change somebody's answer for a
    ## feature. However, we want to take into account multiple
    ## features. If we want a total privacy loss of epsilon.
    p = 0.5 # fix me!
